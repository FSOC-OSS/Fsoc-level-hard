...
const QuizApp = () => {
  ...
  const [userId] = useState(() => {
    ...
    localStorage.setItem('quiz_user_id', newId);
    return newId;
  });
  ...
  }, [isResultAnnouncementComplete, currentQuestionIndex, questions.length, selectedAnswers, score, totalHintsUsed, quizStartTimestamp]);
  ...
  const handleQuestionRating = useCallback((rating) => {
    setQuestionRatings((prev) => [...prev, rating]);
  }, []);
